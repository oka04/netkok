...
public:
	...
	void DrawPrintfCenter(const int centerX, const int y, std::string strFontName, const D3DCOLOR argb, std::string strFormat, ...);
	//=============================================================================
	...
	void GetTextSize(std::string strFontName, const char* message, int* pTextWidth, int* pTextHeight);
	//wmwmwmwmwmwmwmwmwmwmwmwmwmwmwmwmwmwmwmwmwmwmwmwmwmwmwmwmwmwmwmwmwmwmwmwmwmwmw
	//
	// テクスチャ
	// 　テクスチャの追加と解放
