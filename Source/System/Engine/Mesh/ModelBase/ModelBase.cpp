...
void ModelBase::DrawDepth(LPD3DXMATRIX pMatLightVP, LPD3DXMATRIX pMatWorld)
{
	...
	// フレームの深度描画
	m_pFrame->DrawFrameDepth(*(m_pFrame->GetRootFramePointerAddress()), pMatLightVP, m_pEffect);
}
//=============================================================================
// ルートフレームの変換マトリックスを取得
