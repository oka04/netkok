...
namespace AK
{
    ...
    namespace SWITCHES
    {
        namespace GAME_BGM
        {
            static const AkUniqueID GROUP = 3657697988U;

            namespace SWITCH
            {
                static const AkUniqueID CHASE = 417490929U;
                static const AkUniqueID SEARCH = 3045815925U;
            } // namespace SWITCH
        } // namespace GAME_BGM
    ...
    {
        static const AkUniqueID FOOTSPEED = 1297515238U;
    } // namespace GAME_PARAMETERS

    namespace BANKS
    {
        static const AkUniqueID INIT = 1355168291U;
        static const AkUniqueID SB_BGM = 1026403989U;
        static const AkUniqueID SB_SE = 323139049U;
    } // namespace BANKS
